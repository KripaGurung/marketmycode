...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await signupUser.signupUser(payload);
      ...
      <div className="form-container">
        ...
        <div className="steps">
          {[0, 1, 2, 3].map((i) => (
            <div
              key={i}
              className={`step ${form.currentStep >= i ? "active" : ""}`}
            >
              {i + 1}
            </div>
          ))}
        ...
        <form id="register-form" onSubmit={handleSubmit}>
          {form.currentStep === 0 && (
            <div className="formStep active">
              ...
              <button type="button-next" onClick={handleNext}>
                Next
              </button>
            </div>
          )}
          ...
          {form.currentStep === 1 && (
            <div className="formStep active">
              ...
              <input
                ...
                onChange={(e) =>
                  dispatch(
                    updateField({ field: "country", value: e.target.value })
                  )
                }
              />

              <button type="button-next" onClick={handlePrev}>
                Previous
              </button>
              <button type="button-next" onClick={handleNext}>
                Next
          ...
          {form.currentStep === 2 && (
            <div className="formStep active">
              ...
              <select
                ...
                onChange={(e) =>
                  dispatch(
                    updateField({ field: "skill", value: e.target.value })
                  )
                }
              >
