...
const Register = () => {
  ...
  const payload = { username: form.userName, email: form.email, fullname: form.name, password: form.password};
        ...
        <form id="register-form" onSubmit={handleSubmit}>
          {form.currentStep === 0 && (
            <div className="formStep active">
              ...
              <button type="button-next" className="next" onClick={handleNext}> Next </button>
            </div>
          )}
